...
Open `hospital-savings-calculator.html` in any modern browser. Nothing else to install.

To host on GitHub Pages: enable Pages on the repo, and (optionally) rename the file to `index.html` for a clean root URL.
